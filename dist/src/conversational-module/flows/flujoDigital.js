...
exports.procesarFlujoDigital = procesarFlujoDigital;
const promptBuilder_simple_1 = require("../ai/promptBuilder-simple");
/**
 * Flujo ULTRA SIMPLE para productos digitales
 * SIN IA - Solo respuestas directas con información REAL
 */
async function procesarFlujoDigital(mensaje, producto, contexto) {
    ...
    const pideInformacion = mensajeLower.includes('más información') ||
    ...
    if (pideInformacion) {
        ...
        respuesta = (0, promptBuilder_simple_1.respuestaDetalladaProductoDigital)(producto);
    }
    else {
        console.log('[FlujoDigital] ✅ Respuesta DIRECTA básica');
        respuesta = (0, promptBuilder_simple_1.respuestaDirectaProductoDigital)(producto);
    }
 ...
 */
function generarRespuestaDigitalSegura(producto) {
