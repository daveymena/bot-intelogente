...
exports.ClosingAgent = void 0;
const base_agent_1 = require("./base-agent");
class ClosingAgent extends base_agent_1.BaseAgent {
    constructor() {
        super('ClosingAgent');
    }
    /**
...
📧 Email: deinermena25@gmail.com`,
     ...
     */
    handlePaymentConfirmation(memory) {
...
¿Qué necesitas? 💡`,
     ...
     */
    isPaymentConfirmation(msg) {
        return (msg.includes('ya pague') ||
...
exports.ClosingAgent = ClosingAgent;
