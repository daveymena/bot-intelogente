...
exports.DeepReasoningAgent = void 0;
const conversation_context_service_1 = require("@/lib/conversation-context-service");
class DeepReasoningAgent {
    /**
     * Analiza profundamente el contexto de la conversación
     */
    static async analyzeContext(chatId, currentMessage, memory) {
        console.log('\n🧠 [DEEP REASONING] Iniciando análisis profundo...');
        console.log(`📱 Chat: ${chatId}`);
        console.log(`💬 Mensaje: "${currentMessage}"`);
        // 1. Obtener contexto de conversación
        const conversationContext = conversation_context_service_1.ConversationContextService.getProductContext(chatId);
     ...
     */
    static identifyCurrentProduct(memory, conversationContext) {
     ...
     */
    static analyzeUserIntent(message, memory, currentProduct) {
     ...
     */
    static generateRecommendations(userIntent, currentProduct) {
     ...
     */
    static createContextSummary(memory, currentProduct) {
     ...
     */
    static explainReasoning(message, currentProduct, userIntent) {
    ...
    static isPurchaseConfirmation(message) {
    ...
    static isMoreInfoRequest(message) {
        const infoKeywords = [
    ...
    static extractProductNameFromLine(line) {
     ...
     */
    static cleanExtractedProductName(productName) {
...
exports.DeepReasoningAgent = DeepReasoningAgent;
