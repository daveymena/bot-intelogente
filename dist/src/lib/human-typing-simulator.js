...
exports.HumanTypingSimulator = void 0;
class HumanTypingSimulator {
     ...
     */
    static calculateTypingTime(responseLength) {
     ...
     */
    static async simulateTyping(sock, chatId, responseLength) {
        try {
     ...
     */
    static async humanizedSend(sock, chatId, message, userMessageLength) {
        try {
     ...
     */
    static async quickHumanizedSend(sock, chatId, message) {
        try {
     ...
     */
    static shouldUseQuickSend(message) {
     ...
     */
    static addRandomVariation(baseTime) {
        const variation = baseTime * 0.2; // ±20%
        return baseTime + (Math.random() * variation * 2 - variation);
    }
}
exports.HumanTypingSimulator = HumanTypingSimulator;
