...
exports.EmergencyFallbackSystem = void 0;
...
class EmergencyFallbackSystem {
     ...
     */
    static async generateEmergencyResponse(userMessage, userId) {
     ...
     */
    static async getLearnedResponse(message, userId) {
        try {
     ...
     */
    static getPatternResponse(message) {
        // Saludos
     ...
     */
    static getGenericEmergencyResponse() {
     ...
     */
    static async learnFromResponse(userMessage, aiResponse, userId, provider) {
        try {
...
exports.EmergencyFallbackSystem = EmergencyFallbackSystem;
