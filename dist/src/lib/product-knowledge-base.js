...
exports.ProductKnowledgeBaseService = void 0;
...
class ProductKnowledgeBaseService {
     ...
     */
    static async generateKnowledge(productId) {
        try {
     ...
     */
    static async analyzeProduct(product) {
     ...
     */
    static generateMegapackKnowledge(product, name, description, price) {
     ...
     */
    static generateCourseKnowledge(product, name, description, price) {
     ...
     */
    static generateMotorcycleKnowledge(product, name, description, price) {
     ...
     */
    static generateLaptopKnowledge(product, name, description, price) {
        return {
            productId: product.id,
            productName: name,
            category: 'PHYSICAL',
     ...
     */
    static generateGenericKnowledge(product, name, description, price) {
        return {
            productId: product.id,
            productName: name,
...
exports.ProductKnowledgeBaseService = ProductKnowledgeBaseService;
