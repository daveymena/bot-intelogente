...
exports.LandingAIService = void 0;
...
class LandingAIService {
     ...
     */
    static async generateLandingContent(product) {
        try {
     ...
     */
    static async generateWithOpenAI(product) {
     ...
     */
    static async generateWithGroq(product) {
        const prompt = this.buildPrompt(product);
...
`;
     ...
     */
    static async generateHeadline(productName, description) {
        try {
...
Hazlo más persuasivo, claro y orientado a conversión. Máximo 150 caracteres.`;
     ...
     */
    static generateDefaultContent(product) {
        const isDigital = product.category === 'DIGITAL';
        return {
     ...
     */
    static async generateHeadlineVariations(headline, count = 3) {
        try {
            const useOpenAI = process.env.OPENAI_ENABLED === 'true' && process.env.OPENAI_API_KEY;
...
exports.LandingAIService = LandingAIService;
