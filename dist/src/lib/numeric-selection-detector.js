...
exports.NumericSelectionDetector = void 0;
const db_1 = require("./db");
class NumericSelectionDetector {
    /**
     * Detectar si el mensaje es una selección numérica
     */
    static async detectSelection(message, conversationHistory, userId) {
     ...
     */
    static getLastBotMessage(history) {
     ...
     */
    static hasNumberedOptions(message) {
     ...
     */
    static async extractProductsFromList(message, userId) {
        const products = [];
...
exports.NumericSelectionDetector = NumericSelectionDetector;
