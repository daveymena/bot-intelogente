...
exports.IntelligentBaileysIntegration = void 0;
exports.handleMessageWithIntelligence = handleMessageWithIntelligence;
const intelligent_conversation_engine_1 = require("./intelligent-conversation-engine");
const db_1 = require("./db");
class IntelligentBaileysIntegration {
    /**
    ...
    static async handleIntelligentMessage(params) {
        ...
        try {
            const engine = (0, intelligent_conversation_engine_1.getIntelligentEngine)();
     ...
     */
    static async generatePaymentLink(params) {
        try {
            ...
            const result = await BotPaymentLinkGenerator.generatePaymentLinks(params.productId, params.userId, 1 // cantidad
            );
            if (!result.success) {
     ...
     */
    static getConversationStats(chatId) {
        const engine = (0, intelligent_conversation_engine_1.getIntelligentEngine)();
...
exports.IntelligentBaileysIntegration = IntelligentBaileysIntegration;
/**
 * Función principal para usar en baileys-stable-service.ts
 */
async function handleMessageWithIntelligence(params) {
