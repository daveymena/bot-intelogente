...
exports.GmailOAuthService = void 0;
...
class GmailOAuthService {
    ...
    static getOAuth2Client() {
        ...
        this.oauth2Client = new googleapis_1.google.auth.OAuth2(clientId, clientSecret, 'https://developers.google.com/oauthplayground' // Redirect URI
        );
...
exports.GmailOAuthService = GmailOAuthService;
GmailOAuthService.oauth2Client = null;
GmailOAuthService.transporter = null;
