...
exports.FlowIntegration = void 0;
const plantillas_respuestas_bot_1 = require("./plantillas-respuestas-bot");
class FlowIntegration {
     ...
     */
    static async sendResponse(sock, chatId, response) {
        try {
...
exports.FlowIntegration = FlowIntegration;
FlowIntegration.engine = (0, plantillas_respuestas_bot_1.createFlowEngine)();
