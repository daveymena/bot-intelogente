...
exports.salesIntelligence = exports.ProfessionalSalesIntelligence = void 0;
class ProfessionalSalesIntelligence {
    analyzeCustomerIntent(message) {
    ...
    generateSalesPrompt(intent, strategy, products, message) {
...
exports.ProfessionalSalesIntelligence = ProfessionalSalesIntelligence;
exports.salesIntelligence = new ProfessionalSalesIntelligence();
