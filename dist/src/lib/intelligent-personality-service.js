...
exports.IntelligentPersonalityService = void 0;
const db_1 = require("./db");
const conversational_training_examples_1 = require("./conversational-training-examples");
class IntelligentPersonalityService {
    /**
     * Obtener personalidad configurada del usuario
     */
    static async getPersonality(userId) {
        try {
     ...
     */
    static async buildSystemPrompt(userId, businessContext, productsInfo) {
...
- Responde de forma concisa (máximo 5-6 líneas)`;
    ...
    static buildTrainingExamples() {
        ...
        const selectedExamples = conversational_training_examples_1.CONVERSATIONAL_EXAMPLES
     ...
     */
    static buildDefaultPrompt(businessContext, productsInfo, trainingExamples, criticalRule) {
...
exports.IntelligentPersonalityService = IntelligentPersonalityService;
